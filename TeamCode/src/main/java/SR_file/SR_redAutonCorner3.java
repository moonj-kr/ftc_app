...
@Autonomous(name = "SR_redAutonCorner3", group = "Linear Opmode")
@Disabled
/**
...
public class SR_redAutonCorner3 extends LinearOpMode {
        ...
        while(opModeIsActive()) {
            ...
            switch (counter) {
                ...
                case 0:
                    ...
                    M_drive_R.setTargetPosition(740); //295 cm
                    M_drive_L.setTargetPosition(740); //1120 2240 740

                    M_drive_R.setPower(0.5); //INCREASE POWER FROM .3 TO .6
...
// change motor to rotate little more
                    ...
                    double angleZ_two  = gyro.getIntegratedZValue();
                ...
                case 3: // ADJUST SPEED AND DISTANCE
                    ...
                    M_drive_R.setTargetPosition(8921); //295 cm //10021 original to 9821. 9021 did not hit wall
                    M_drive_L.setTargetPosition(8921); //10021 - 740 = 9
                    ...
                    angleZ_two  = gyro.getIntegratedZValue();
                    telemetry.addData("After Drive. %03d", angleZ_two);
                    telemetry.update();
                    counter++;
                    break;
                ...
                case 4:
                    ...
                    double deg2 = -42.0; //40 was original
                    double j = 2;
...
/*
                        if (rangeSensorLeft.getDistance(DistanceUnit.CM) > 9 + 1) {
                            ...
                            telemetry.update();
                            M_drive_L.setPower(0.06); //too slow, 18, -number to 18, 20, 18, 20
                            M_drive_R.setPower(0.08);
                ...
                case 7: //INCREASE POWER AND DECREASE DISTANCE
                    ...
                    M_drive_R.setTargetPosition(3082); //295 cm
                    M_drive_L.setTargetPosition(3082);

                    M_drive_R.setPower(0.3); //INCREASE POWER FROM .3 TO .6
                    M_drive_L.setPower(0.3);
